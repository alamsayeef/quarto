...
date-format: long
author: 
  - name: Alya Ghina Aqila Arham
  - name: Fikria Karinanur
  - name: Jonas Grevle Hofmo
...
```{r libs, include=F}
librarian::shelf(tidyverse, dagitty, ggdag, ggplot2, gt, sjPlot, stargazer, quiet = T)
```

## Introduction


Celiac disease (CD) has become globally common in all age groups [@vilppula2009increasing], especially among Caucasian populations who are genetically predisposed. The prevalence of CD has significantly increased over the past 50 years and in the northern Europe it is prevalent among 1-2% of the population [@lohi2007increasing]. While the global prevalence of CD is around 1% [@singh2018global], some Nordic populations have recorded higher than global average numbers [@vilppula2009increasing; @kvamme2022population; @dydensborg2012increasing; @myleus2009celiac]. 
...
Several studies have indicated CD to be associated significantly with environmental factors such as short breastfeeding [@akobeng2006effect], caesarean delivery [@maarild2012pregnancy], childhood infections [@stene2006rotavirus] etc. However, individual studies [@snook1996adult;@vazquez2001relation] 
and even a comprehensive meta-analysis [@wijarnpreecha2018cigarette]
...
To refer @fig-dag do as the code suggest.

Descriptive table, To refer @tbl-table1 do as the code suggest.
...
Relative risk table refer @tbl-table2 do as the code suggest.
